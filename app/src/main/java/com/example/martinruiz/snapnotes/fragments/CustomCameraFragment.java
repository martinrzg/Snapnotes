...
public class CustomCameraFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        imageViewCameraButton = getActivity().findViewById(R.id.imageViewCameraButton);
        assert imageViewCameraButton != null;
        assert textureView != null;
        textureView.setSurfaceTextureListener(textureListener);

        imageViewCameraButton.setOnClickListener(view1 -> takePicture() );
